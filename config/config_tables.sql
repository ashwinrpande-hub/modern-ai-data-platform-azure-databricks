...
CREATE CATALOG IF NOT EXISTS acme_bronze;
CREATE SCHEMA IF NOT EXISTS acme_bronze.audit;
CREATE SCHEMA IF NOT EXISTS acme_bronze.cfg;

-- Source registry: one row per registered source (mirrors replication_sources.yaml)
CREATE TABLE IF NOT EXISTS acme_bronze.cfg.source_registry (
...
CREATE TABLE IF NOT EXISTS acme_bronze.cfg.layer_mappings (
...
CREATE TABLE IF NOT EXISTS acme_bronze.audit.rejected_records (
...
CREATE TABLE IF NOT EXISTS acme_bronze.audit.batch_log (
