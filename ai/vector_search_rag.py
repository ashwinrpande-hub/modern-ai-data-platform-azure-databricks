...
vsc.create_delta_sync_index(
    ...
    index_name="acme_gold.ai.customer_profile_idx",
    source_table_name="acme_gold.ai.customer_profile_text",  # built from dim_customer + features
...
def semantic_search(q: str, k: int = 5):
    idx = vsc.get_index(ENDPOINT, "acme_gold.ai.customer_profile_idx")
...
# retriever -> prompt with citations -> served via Model Serving endpoint 'acme-sales-rag'
