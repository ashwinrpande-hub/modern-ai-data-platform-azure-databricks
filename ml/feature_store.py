...
features = (spark.table("acme_gold.sales.fact_sales_orders")
    .groupBy("customer_hk")
...
OFFLINE = "acme_gold.ml.customer_features"
...
try:
    w.database.create_synced_database_table({
        "name": "acme_gold.ml.customer_features_online",
        "spec": {"source_table_full_name": OFFLINE,
                 ...
                 "database_instance_name": "acme-lakebase",
